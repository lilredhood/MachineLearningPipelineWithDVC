...
from urllib.parse import urlparse # obtenir le schéma du répo remote
...
def hyperparameter_tuning(X_train, y_train, param_grid) :
    ...
    return grid_search # Les meilleurs hyperparametres
...
def train(data_path, model_path, random_state, n_estimators, max_depth) :
    ...
    # tracking
    mlflow.set_registry_uri("https://dagshub.com/lilredhood/MachineLearningPipeline.mlflow")
    ...
    with mlflow.start_run() :
        ...
        filename = model_path
        pickle.dump(best_model, open(filename, 'wb')) # Ecriture du modèle

        print(f"Model saved to {model_path}")



# Tout le tracking se fait dans Dagshub
